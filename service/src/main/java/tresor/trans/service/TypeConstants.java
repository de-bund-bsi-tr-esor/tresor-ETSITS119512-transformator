...
public class TypeConstants {
	...
	public static final String TRESOR_API_NS = "http://www.bsi.bund.de/tr-esor/api/1.2";
	public static final String TRESOR_VR_NS = "http://www.bsi.bund.de/tr-esor/vr/1.2";

	public static final String XAIP_TYPE = "http://www.bsi.bund.de/tr-esor/xaip/1.2";
	public static final String LXAIP_TYPE = "http://www.bsi.bund.de/tr-esor/lxaip/1.3";
	public static final String DXAIP_TYPE = "http://www.bsi.bund.de/tr-esor/dxaip/1.2";
	public static final String DLXAIP_TYPE = "http://www.bsi.bund.de/tr-esor/dlxaip/1.2";
	...
	public static final String BINARYDATA_TYPE = "http://www.bsi.bund.de/tr-esor/api/1.2/type/binaryData";
	...
	public static final Set<String> SUPPORTED_XPATH_QUERY = Set.of("http://www.bsi.bund.de/tr-esor/api/1.2/query/xpath");
